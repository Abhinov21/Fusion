...
class ConsultancyProjectStatus(models.TextChoices):
    COMPLETED = "Completed", "Completed"
    SUBMITTED = "Submitted", "Submitted"
    ONGOING = "Ongoing", "Ongoing"
...
class ResearchProject(models.Model):
    ...
    status = models.CharField(
        ...
        default=ResearchProjectStatus.ONGOING
    )
...
class ConsultancyProject(models.Model):
    ...
    date_entry = models.DateField(null=True, blank=True, default=datetime.datetime.now)
    status = models.CharField(
        default=ConsultancyProjectStatus.ONGOING,
        max_length=10,
        choices=ConsultancyProjectStatus.choices,
        null=True,
        blank=True
    )
